...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Use the arrowkeys to move your snake. If you need more instruction, you don't deserve to play Snake";
	...
	private void setFoodLocation() {
		...
		location = new Location(rand.nextInt(15), rand.nextInt(12));
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Sorry gamer, but yo snake ded");
		// 3. ask them if they want to play again.
		String answer = JOptionPane.showInputDialog("Wanna play again loser?");
